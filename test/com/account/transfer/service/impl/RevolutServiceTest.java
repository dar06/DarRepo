...
public class RevolutServiceTest {
   ...
   @Test
    public void shouldTransferMoney() {
        ...
        accountService.registerAccount(fromAccount);
        accountService.registerAccount(toAccount);

        //when
        final TransferResponse transferResponse = accountService.transfer(createTransferRequest("111", "222", new BigDecimal("50")));
    ...
    public void shouldNotTransferWhenInsufficientBalance() {
        ...
        //when
        final TransferResponse transferResponse = accountService.transfer(createTransferRequest("111", "222", new BigDecimal("250")));
    ...
    public void shouldNotTransferWhenFromAndToAccountSame() {
        ...
        //when
        final TransferResponse transferResponse = accountService.transfer(createTransferRequest("111", "111", new BigDecimal("250")));
